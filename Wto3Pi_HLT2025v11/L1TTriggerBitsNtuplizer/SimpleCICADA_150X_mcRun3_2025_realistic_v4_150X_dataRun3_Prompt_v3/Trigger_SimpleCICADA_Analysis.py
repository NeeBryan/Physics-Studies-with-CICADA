...
def analyze_triggers(mc_file, data_file, output_file):
    ...
    cicada_trigger = "L1_CICADA_VLoose"
    cicada_vals = []
    ...
    top20 = sorted(trigger_means.items(), key=lambda x: x[1], reverse=True)[:26]
    ...
    hist_orig.SetTitle(f"Trigger Efficiencies Alone (full 150X conditions) (MC: Wto3Pi)")
    hist_orig.Draw("HIST")
    ...
    # Save Canvas 1
    output1_png = f"top20_trigger_means_{mc_basename}_150X.png"
    ...
    hist_or.SetTitle(f"Trigger Efficiencies with CICADA OR (full 150X conditions) (MC: Wto3Pi)")
    hist_or.Draw("HIST")
    ...
    # Save Canvas 2
    output2_png = f"compare_OR_CICADA_{mc_basename}_150X.png"
...
mc_files = [
    "/afs/hep.wisc.edu/user/cnee/Wto3Pi/MC_Production/CMSSW_15_0_7/src/simple_CICADA_150X_mcRun3_2025_realistic_v4_140X_dataRun3_Prompt_v4_HcalPFCuts_2023_V1p0_HB_1p5x/CICADA_HIG-RunIISummer20UL17HLT_2025v11-13144.root"
]

data_file = "/afs/hep.wisc.edu/home/cnee/Wto3Pi/CMSSW_15_0_7/src/PU_Run3Winter24GS/L1TTriggerBitsNtuplizer/SimpleCICADA_150X_mcRun3_2025_realistic_v4_150X_dataRun3_Prompt_v3/CICADA_ScoutingPFRun3Run2023B.root"
